...
<body>
	...
	<div class="limiter">
		<!-- <div class="container-login100" style="background-image: url('images/images (3).jpg');"> -->
		<div class="container-login100" style="background-color: #47476b; background: rgb(181,189,200); /* Old browsers */
