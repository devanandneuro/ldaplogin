...
<head>
  ...
  <script>
  function doSummary() {
		if ("document.CktRemovalForm.ord.focus()") {
			document.getElementById('ReturnMsgDiv').style.display = 'none';
	}
		if ("document.CktRemovalForm.ckt.focus()") {
			document.getElementById('ReturnMsgDiv').style.display = 'none';
	}
  }
  </script>
...
<script>
	function Signout() {
		document.CktRemovalForm.method = "post";
		document.CktRemovalForm.action = "./Signout";
		document.CktRemovalForm.submit();
	}
</script>
</head>
<body>
...
<form class="form-horizontal" action="CircuitRemovalServlet" method = "post" name = "CktRemovalForm">
...
<br><br><center><h2 style="font-family: Arial; font-size: 28px; font-weight: bold;">ISR Circuit Removal</h2></center><br><br>
<div class="col-md-4 col-md-offset-4">

  <div class="form-group">
    <label class="control-label col-sm-5" for="order">Order Number</label>
    <div class="col-sm-7">
      <input type="text" class="form-control" name="orderid" id = "ord" placeholder="Enter Order Number" onclick="doSummary();">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-5" for="circuit">Circuit / Ecckt</label>
    <div class="col-sm-7">
      <input type="text" class="form-control" name="circuitid" id = "ckt" placeholder="Enter Circuit / Ecckt" onclick="doSummary();">
    </div>
  </div>
  <div class="form-group">
