...
<script>
	function Signout() {
		document.HealerDDFixForm.method = "post";
		document.HealerDDFixForm.action = "./Signout";
		document.HealerDDFixForm.submit();
	}
	function doSummary() {
		if ("document.HealerDDFixForm.ord.focus()") {
...
<form class="form-horizontal" name = "HealerDDFixForm" action="DDCompletionServlet" method = "post">
...
<center><h2 style="font-family: Arial; font-size: 28px; font-weight: bold;">Due Date Completion</h2></center><br><br>

  <div class="form-group">
    <label class="control-label col-sm-5" for="order">Order Number</label>
    <div class="col-sm-7">
      <input type="text" class="form-control" name = "order" id="ord" placeholder="Enter Order Number" onclick="doSummary();">
    </div>
  </div>
  <div class="form-group">
